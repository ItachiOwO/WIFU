...
from wifu._version import __version__
...
def restart(mode):
    ...
    if mode == 'AUTO':
        os.system("touch /root/.wifu-auto")
    else:
        os.system("touch /root/.wifu-manual")

    os.system("service bettercap restart")
    os.system("service wifu restart")
