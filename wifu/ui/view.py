...
import wifu.ui.faces as faces
import wifu.ui.fonts as fonts
import wifu.ui.web as web
import wifu.utils as utils
from wifu.ui.components import *
from wifu.ui.state import State
from wifu.voice import Voice
...
class View(object):
    def __init__(self, config, impl, state=None):
        ...
        self._state = State(state={
            ...
            'name': Text(value='%s>' % 'wifu', position=self._layout['name'], color=BLACK, font=fonts.Bold),
