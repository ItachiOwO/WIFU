...
import wifu
import wifu.utils as utils
import wifu.plugins as plugins
from wifu.ui.web.server import Server
from wifu.automata import Automata
from wifu.log import LastSession
from wifu.bettercap import Client
from wifu.mesh.utils import AsyncAdvertiser
from wifu.ai.train import AsyncTrainer

RECOVERY_DATA_FILE = '/root/.wifu-recovery'
...
class Agent(Client, Automata, AsyncAdvertiser, AsyncTrainer):
    def __init__(self, view, config, keypair):
        ...
        logging.info("%s@%s (v%s)", wifu.name(), self.fingerprint(), wifu.__version__)
