...
VERSION_FILE = 'wifu/_version.py'
wifu_version = version(VERSION_FILE)

setup(name='wifu',
      version=wifu_version,
      description='(⌐■_■) - WPA2/WPA3 Attack Toolkit with Deep Reinforcement Learning instrumenting bettercap for WiFI pwning.',
      author='evilsocket && the dev team',
      author_email='evilsocket@gmail.com',
      url='https://wifu.ai/',
      license='GPL',
      install_requires=required,
      scripts=['bin/wifu', 'bin/pwnagotchi'],
      package_data={'wifu': ['defaults.toml', 'wifu/defaults.toml', 'locale/*/LC_MESSAGES/*.mo']},
